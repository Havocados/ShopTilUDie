export function kontaktPageContent(
  ...
  target.innerHTML = /* html */ `
      <div class="section p-4 text-start bg-light">
        <div class="container">
          <div style="background-color: #edebeb; color: #0623c4; font-family: Microsoft Sans Serif, Helvetica, Arial, sans-serif; width: 600px; height: 200px; padding: 20px; margin: auto; position:relative;">
    <div style="float:left; width: 36%; overflow: hidden;">
        <div style="
            background-color: rgba(29, 39, 232, 0.677); opacity: 85%">
        <img src="https://live.staticflickr.com/65535/51274706071_b858cdd19a_h.jpg" height="200px" width="100%" style="object-fit:cover; transform: scale(1.5);  filter:grayscale(1); mix-blend-mode: screen;">
    </div></div>
